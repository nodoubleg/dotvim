...
if has("gui_running")
  ...
  hi NonText        guibg=#1F1F1F guifg=#007ae3 gui=none
  ...
  " -> Line info  
  hi LineNr         guibg=#000000 guifg=#86711a gui=none
  ...
  hi Identifier     guibg=#1F1F1F guifg=#2697ff gui=none
  ...
  hi Special        guibg=#1F1F1F guifg=#eb4187 gui=none
  ...
  hi Type           guibg=#1F1F1F guifg=#90c026 gui=none
...
elseif &t_Co == 256
  ...
  " -> HTML-specific
 htmlBold                 ctermbg=234  ctermfg=252   cterm=bold
